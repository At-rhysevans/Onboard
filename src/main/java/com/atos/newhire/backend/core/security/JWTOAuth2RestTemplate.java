package com.atos.newhire.backend.core.security;

import com.atos.newhire.backend.core.exception.LauncherException;
...
// Special handling for consent_required
            ...
            if (message != null && message.contains("consent_required")) {
                consent_url = String.format("https://%s/oauth/auth?prompt=login&response_type=code&scope=%s" +
                    ...
                    consent_scopes,
                    resource.getClientId(),
                    "http://ec2-18-133-225-203.eu-west-2.compute.amazonaws.com:8080/login%26type%3Djwt");
