...
import com.atos.newhire.backend.core.security.JWTAuthorizationCodeResourceDetails;
import com.atos.newhire.backend.core.security.JWTOAuth2RestTemplate;
import com.atos.newhire.backend.core.security.JWTUserInfoTokenService;
import com.atos.newhire.backend.core.security.OAuthProperties;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
            .antMatcher("/**")
            .authorizeRequests()
            .antMatchers("/sign**", "/error**", "/assets/**","/ds/mustAuthenticate**",
                "/ds/authenticate**")
            .permitAll()
            .anyRequest()
            .authenticated()
